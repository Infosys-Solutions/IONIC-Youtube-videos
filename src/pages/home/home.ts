...
export class HomePage {
 ...
 channelID: string = 'UCXY2FsrLZbaQtPtmYEMLJqA';
  maxResults: string = '10';
  pageToken: string; 
  googleToken: string = 'AIzaSyBpGMcqNye0YAczXj6Vm67WHfAvjAuV8KQ';
  searchQuery: string = 'E pakistan';
  posts: any = [];
 ...
 console.log('i am fecthing');
  ...
  loadMore(): void {
      console.log("TODO: ImplementloadMre()");
  }
